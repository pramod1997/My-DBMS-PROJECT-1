		...
		<div id="header">
			<div>
				...
				<ul id="navigation">
					...
					<p><font color ="pink"><h2>APPLICATION : DISPLAY LEAGUE AND COUNTRY </h2></font></p>
				</div>
...
$sql = "call innerjoin_1()";
$result = $conn->query($sql);
echo "<table class= 'rwd-table' cellspacing='0'>";
echo "<thead>";
echo "    <tr>";
echo "  <th>League_id</th>";

echo " <th>country_name</th>";
echo "	<th>League_name</th>";
...
if ($result->num_rows > 0) {
    ...
    $errormsg="ERROR : Couldnt execute query or 0 result  ";
		echo "<div >";
