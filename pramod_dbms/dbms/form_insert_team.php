		...
		<div id="header">
			<div>
				...
				<ul id="navigation">
					...
					<p><font color ="pink"><h2>APPLICATION : INSERT INTO TABLE TEAM</h2></font></p>
				</div>
			



<form class="form-style-9" action="form_insert_team.php" method="get">
<ul>
 Id :
<li>
...
Team Api id :
<li>
    <input type="number" name="tid" class="field-style field-split align-left" placeholder="" /></li>

 
   Team fifa api id:
   <li><input type="number" name="tfid" class="field-style field-split align-left" placeholder="" /></li>
     Long Name:
   <li><input type="text" name="lname" class="field-style field-split align-left" placeholder="" /></li>
   Short Name:
   <li><input type="text" name="sname" class="field-style field-split align-left" placeholder="" /></li>
...
if(isset($_GET['tid']) ){
	...
	//echo $id ; 
	//echo $cname;
	$sql = "INSERT into `Team` (`id` , `team_api_id`,team_fifa_api_id,team_long_name,team_short_name) VALUES ('$id' , '$tid', '$tfid','$lname','$sname')";
