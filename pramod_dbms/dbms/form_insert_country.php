...
<br><BR>
					...
					<p><font color ="pink"><h2>APPLICATION :  TO INSERT RECORDS IN COUNTRY TABLE</h2></font></p>
				</div>



<form class="form-style-9" action="form_insert_country.php" method="get">
<ul>
Country ID:
<li>
    <input type="number" name="id" class="field-style field-split align-left" placeholder="" /></li>
Country Name:
   <li><input type="text" name="cname" class="field-style field-split align-left" placeholder="" /></li>
...
<?php
if(isset($_GET['id']) && isset($_GET['cname']) && !empty($_GET['id']) && !empty($_GET['cname'])){
	$id = $_GET['id'];
	$cname = $_GET['cname'];
	//echo $id ; 
	//echo $cname;
	$sql = "INSERT into `Country` (`id` , `name`) VALUES ('$id' , '$cname')";
