		...
		<div id="header">
			<div>
				...
				<ul id="navigation">
					...
					<font><p><h2 align = "center"> USES UPDATE </h2></p>
					<p><font color ="pink"><h2>APPLICATION : UPDATE RECORDS IN TABLE</h2></font></p>
				</div>


<form class="form-style-9" action="updateform.php" method="get">
<ul>
UPDATE
<li>
    <input type="text" name="id" class="field-style field-split align-left" placeholder="" /></li>
From TABLE 
...
if(isset($_GET['id'])  ){
	...
	$name = $_GET['name'];
	$clause = $_GET['clause'];
	$sql1= "UPDATE ".$name. " set ".$id." where  ".$clause;
